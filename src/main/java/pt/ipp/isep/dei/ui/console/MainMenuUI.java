...
public class MainMenuUI {
    ...
    private final CreateAircraftModelUI createAircraftModelUI;
    ...
    public MainMenuUI(
        ...
        if (createAircraftModelUI == null) {
            throw new IllegalArgumentException("Create aircraft model UI cannot be null.");
        }
        ...
        this.createAircraftModelUI = createAircraftModelUI;
    ...
    public void run() {
        ...
        do {
            ...
            switch (option) {
                ...
                case 10 -> runCreateAircraftModel();
    ...
    private void runCreateAircraftModel() {
        try {
            authorizationService.requirePermission("CREATE_AIRCRAFT_MODEL");
            createAircraftModelUI.run();
        } catch (SecurityException exception) {
            displayAccessDenied(exception);
        }
    }
    ...
    private void showMenu() {
        ...
        System.out.println("10 - Create Aircraft Model");
